...
<p align="center">
  <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=1200" alt="EmoSpot Banner" width="100%" style="border-radius: 24px; max-height: 380px; object-fit: cover;" />
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Developed%20By-FANTASTIC__6-indigo?style=for-the-badge&logo=heart&logoColor=rose" alt="Developed by FANTASTIC_6" />
  <img src="https://img.shields.io/badge/Challenge%20Track-02%20Early%20Warning%20System-blue?style=for-the-badge&logo=target" alt="Track 02 Early Warning" />
  <img src="https://img.shields.io/badge/Architecture-Support%2C%20Not%20Surveillance-emerald?style=for-the-badge&logo=shield" alt="Support Not Surveillance" />
...
```mermaid
graph TD
    A[Step 1: Check-In Completed\nVoluntary 30s student reflection] --> B[Step 2: Support Recommended\nTransparent deterministic rule SR-02]
    B --> C[Step 3: Support Request Submitted\nStudent opts in for campus reach-out]
    C --> D[Step 4: Staff Assigned & Outreach\nAuthorized coordinator sends warm message]
    D --> E[Step 5: Appointment Scheduled\nProvisional 20-min conversation booked]
    E --> F[Step 6: Continuous Follow-Up\nLight-touch check-ins across semester]
    F --> G[Step 7: Support Completed\nResolution recorded with student satisfaction]
```
